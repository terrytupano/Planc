...
/**
 * An implementation of the HOTP generator specified by RFC 4226. Generates short passcodes that may be used in
 * challenge-response protocols or as timeout passcodes that are only valid for a short period.
 * 
 * The default passcode is a 6-digit decimal code and the default timeout period is 5 minutes.
 * 
