...
public class TTreeTableCellRenderer extends JTree implements TableCellRenderer {
    /** Die letzte Zeile, die gerendert wurde. */
    protected int visibleRow;
     
    private TTreeTable treeTable;
     
    public TTreeTableCellRenderer(TTreeTable treeTable, TreeModel model) {
        super(model);
