...
public class PaletteEntryCellRenderer extends DefaultListCellRenderer {
	/**
	 * The following colors are used to draw the marker that marks the closest color in the palette. The "closest color"
	 * is used, when the palette does not contain an exact match to the currently selected color in the color chooser.
	 * The marker is used to help the user finding the closest color in the palette.
	 */
