...
public class PaletteListModel extends AbstractListModel {
	...
	/**
	 * Computes the index of the color which comes closest to the specified color. This may return -1, if there is no
	 * sufficiently close color in the color list.
	 */
	...
	/**
	 * Returns the index of the color which is closest to the current color in the color chooser, or -1 of no such color
	 * exists.
	 */
