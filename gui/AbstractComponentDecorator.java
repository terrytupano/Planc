...
/**
 * Provide a method for consistently augmenting the appearance of a given component by painting something on it
 * <i>after</i> the component itself gets painted. If not explicitly removed via {@link #dispose}, an instance of this
 ...
 * <p>
 * The decoration is clipped to the bounds set on the decoration, which does not necessarily need to be the same as the
 * decorated component bounds. The decoration may extend beyond the decorated component bounds, or it may be reduced to
 * a smaller region.
 */
...
public abstract class AbstractComponentDecorator {
	...
	/**
	 * Account for the difference between the decorator actual origin and the logical origin we want to pass to the
	 * {@link #paint} method.
	 */
	...
	/**
	 * Create a decorator for the given component, indicating the layer offset from the target component. Negative
	 * values mean the decoration is painted <em>before</em> the target component is painted.
	 */
	...
	/**
	 * Create a decorator with the given position within its layer. Use {@link #TOP} to cover other decorations, or
	 * {@link #BOTTOM} to be covered by other decorations.
	 * <p>
	...
	/**
	 * Provide for different tool tips depending on the actual location over the decoration. Note that if you
	 * <em>only</em> override this method, you must also invoke {@link #setToolTipText(String)} with a non-<span
	...
	/**
	 * Indicate whether any of the decoration is visible. The decoration may be clipped by ancestor scroll panes or by
	 * being moved outside if the visible region of its parent window.
	 */
	...
	/**
	 * Adjust the painting offsets and size of the decoration to account for ancestor clipping. This might be due to
	 * scroll panes or having the decoration lie outside the parent layered pane.
	 */
	...
	/**
	 * Return any clipping rectangle detected above the given component, in the coordinate space of the given component.
	 * The given rectangle is desired to be visible.
	 */
	...
	/**
	 * Change the bounds of the decoration, relative to the decorated component. The special value
	 * {@link #DEFAULT_BOUNDS} means the bounds will track the component bounds.
	 */
	...
	private class Painter extends JComponent {
		...
		/**
		 * Returns the cursor of the decorated component, or the last cursor set by {@link #setCursor}.
		 */
	...
	/**
	 * Provides a shared background painting mechanism for multiple decorations. This ensures that the background is
	 * only painted once if more than one background decorator is applied.
	 */
