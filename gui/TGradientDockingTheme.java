 ...
 * @since IDW 1.1.0
 */
public class TGradientDockingTheme extends DockingWindowsTheme {
   ...
   */
  public TGradientDockingTheme(boolean opaqueTabArea, boolean shadowEnabled, boolean highlightedBold,
  ...
  public TGradientDockingTheme(boolean opaqueTabArea, boolean shadowEnabled, boolean highlightedBold,
    ...
    GradientTheme theme = new GradientTheme(opaqueTabArea, shadowEnabled, borderColor, tabAreaBackgroundColor);
