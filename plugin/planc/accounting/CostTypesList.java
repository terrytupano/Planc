...
/**
 * planc sle_cost_types list
 * 
 */
public class CostTypesList extends UIListPanel implements DockingComponent {

	private ServiceRequest serviceRequest;
	private String companyID;

	public CostTypesList() {
		super(null);
		this.serviceRequest = new ServiceRequest(ServiceRequest.DB_QUERY, "sle_cost_types", null);
		...
		putClientProperty(TConstants.ICON_PARAMETERS, "0;CostTypesList");
		putClientProperty(SLEPlanC.PLANC_ID, 80052L);
	}
	...
	public UIComponentPanel getUIFor(AbstractAction aa) {
		...
		if (aa instanceof NewRecord) {
			...
			pane = new CostTypesRecord(mod, true);
		}
		if (aa instanceof EditRecord) {
			pane = new CostTypesRecord(getRecord(), false);
		}
		return pane;
	}
